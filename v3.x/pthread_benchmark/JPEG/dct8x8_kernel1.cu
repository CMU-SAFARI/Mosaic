...
* \param OffsetXBlocks	[IN] - Offset along X in blocks from which to
*perform processing
* \param OffsetYBlocks	[IN] - Offset along Y in blocks from which to
*perform processing
*
* \return None
*/
__global__ void CUDAkernel1DCT(float* Dst,
                               int ImgWidth,
                               int OffsetXBlocks,
                               int OffsetYBlocks) {
  // Block index
...
* \return None
*/
__global__ void CUDAkernel1IDCT(float* Dst,
                                int ImgWidth,
                                int OffsetXBlocks,
                                int OffsetYBlocks) {
  // Block index
