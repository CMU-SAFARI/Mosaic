...
*
* \param FirstIn		[IN] - Pointer to the first element of input
*vector
* \param StepIn			[IN] - Value to add to ptr to access other
*input elements
* \param FirstOut		[OUT] - Pointer to the first element of output
*vector
* \param StepOut		[IN] - Value to add to ptr to access other
*output
*elements
*
* \return None
*/
void SubroutineDCTvector(float* FirstIn,
                         int StepIn,
                         float* FirstOut,
                         int StepOut) {
...
* \return None
*/
void SubroutineIDCTvector(float* FirstIn,
                          int StepIn,
                          float* FirstOut,
                          int StepOut) {
